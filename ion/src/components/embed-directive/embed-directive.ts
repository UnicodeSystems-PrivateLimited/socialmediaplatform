...
/*
  Generated class for the EmbedDirective directive.

  See https://angular.io/docs/ts/latest/api/core/index/DirectiveMetadata-class.html
  for more info on Angular 2 Directives.
*/
@Directive({
  selector: '[embed-directive]' // Attribute selector
})
export class EmbedDirective {
  ...
  constructor(private el: ElementRef, private dataService: DataService) {
    console.log('Hello EmbedDirective Directive');
  }
  ngAfterViewInit() {
    this.getEmbedVideo();
  }
  ...
  assignMetaData(data) {
    if (data.data.openGraph) {
      ...
      console.log('datag', data.data.general);   //2. general next priority
  ...
  //     this.el.nativeElement.innerHTML = `<a target=\"_blank\" href=\"${this.postLinkY} \" class=\"ml-container layout-row\"><div class=\"ml-image-wrap\"><img src=\" ${image}\" ></div><div class=\"ml-data-wrap\"><div class=\"ml-title\"> ${title}</div><div class=\"ml-desc\">${description}</div></div> </a> `;
  //   }
  //   else if (title && description) {
  //     this.el.nativeElement.innerHTML = `<a target=\"_blank\" href=\"${this.postLinkY} \" class=\"ml-container layout-row\"><div class=\"ml-data-wrap\"><div class=\"ml-title\"> ${title}</div><div class=\"ml-desc\">${description}</div></div> </a> `;
  //   }
  //   else if (title) {
  //     this.el.nativeElement.innerHTML = `<a target=\"_blank\" href=\"${this.postLinkY} \" class=\"ml-container layout-row\"><div class=\"ml-data-wrap\"><div class=\"ml-title\"> ${title}</div></div> </a> `;
  //   }
  // }
